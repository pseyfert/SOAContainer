...
namespace SOA {
    ...
    namespace impl {
        ...
        template <bool, class... FIELDS>
        struct _SOASkinCreator {
            template <class BASE>
            using type = typename SOASkinCreatorSimple<
                                    FIELDS...>::template type<BASE>;
        };
        // helper for SOASkinCreator
        ...
        // SOASkinCreator: skin, or autogenerated skin from list of fields
        template <class FIELDORSKIN, class... FIELDS>
        struct SOASkinCreator {
            template <class BASE>
            using type = typename _SOASkinCreator<
              is_skin<FIELDORSKIN>(), FIELDORSKIN, FIELDS...>::template type<BASE>;
        };
    } // impl
} // SOA
